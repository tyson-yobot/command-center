...
def log_integration_test_to_airtable(
    ...
    # WORKING AIRTABLE CONFIGURATION - SYNCHRONIZED WITH DASHBOARD
    airtable_api_key = 'paty41tSgNrAPUQZV.7c0df078d76ad5bb4ad1f6be2adbf7e0dec16fd9073fbd51f7b64745953bddfa'
    base_id = "appRt8V3tH4g5Z5if"  # Matches dashboard table
    table_id = "tbly0fjE2M5uHET9X"   # Matches dashboard table
