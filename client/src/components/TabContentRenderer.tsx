...
export function TabContentRenderer({ 
  ...
  const AutomationOpsContent = () => (
    <div className="space-y-6">
      {/* Lead Intelligence & Automation Grid */}
      <Card className="bg-slate-800/60 backdrop-blur-sm border border-blue-400/50">
        <CardHeader>
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-3 gap-4">
            {/* Lead Scraper Button */}
            <Button
              onClick={handlers.handleLeadScraper}
            ...
            {/* MailChimp Sync */}
            <Button
              onClick={handlers.handleMailchimpSync}
            ...
            >
              <div className="text-center">
                ...
                <span className="text-sm font-medium">MailChimp Sync</span>
              </div>
            </Button>

            {/* Content Creator */}
            <Button
              onClick={handlers.handleContentCreatorSync}
            ...
            <Button
              ...
              className="!bg-red-600 hover:!bg-red-700 !text-white flex items-center justify-center p-4 h-24 border border-red-500"
