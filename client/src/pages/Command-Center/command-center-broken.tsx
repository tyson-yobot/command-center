...
export default function CommandCenter() {
  ...
  const testStats = {
    totalTests: currentSystemMode === 'development' ? (automationPerformance?.data?.totalTests || 74) : (automationPerformance?.data?.totalTests || null),
    passedTests: currentSystemMode === 'development' ? (automationPerformance?.data?.passedTests || 71) : (automationPerformance?.data?.passedTests || null),
    successRate: currentSystemMode === 'development' ? (automationPerformance?.data?.successRate || 95.9) : (automationPerformance?.data?.successRate || null)
  };
      ...
      <div className="w-full">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <Badge className={`${isListening ? 'bg-green-500' : 'bg-gray-500'} text-white flex items-center`}>
                ...
                {isListening ? 'Listening...' : (currentSystemMode === 'development' ? 'Idle' : '')}
              </Badge>
            </div>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border border-blue-400 relative">
              <CardHeader>
                <CardTitle className="text-white flex items-center justify-between">
                  ...
                  <Badge className="bg-green-600 text-white">{currentSystemMode === 'development' ? '🟢 Active' : ''}</Badge>
                </CardTitle>
              </CardHeader>
              {!collapsedSections['core-automation'] && (
                <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <Card className="bg-white/10 backdrop-blur-sm border border-blue-400">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-white">
                {currentSystemMode === 'development' ? '8' : ''}
              </div>
              <p className="text-xs text-green-400">
                {currentSystemMode === 'development' ? (metrics?.activeCalls ? 'Live voice sessions' : 'No active sessions') : ''}
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/10 backdrop-blur-sm border border-blue-400">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-white">
                {currentSystemMode === 'development' ? '47' : ''}
              </div>
              <p className="text-xs text-blue-400">
                {currentSystemMode === 'development' ? 'AI operations active' : ''}
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/10 backdrop-blur-sm border border-blue-400">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-white">
                {currentSystemMode === 'development' ? '94.2%' : ''}
              </div>
              <p className="text-xs text-emerald-400 flex items-center">
                {automationPerformance?.successRate && <div className="w-1 h-1 bg-emerald-400 rounded-full mr-1"></div>}
                {currentSystemMode === 'development' ? (automationPerformance?.successRate ? 'Live automation rate' : 'No automation data') : ''}
              </p>
            </CardContent>
          </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="text-2xl font-bold text-blue-400">
                    {currentSystemMode === 'development' ? '47' : (automationPerformance?.data?.totalTests || '')}
                  </div>
                  <div className="text-xs text-blue-400 flex items-center">
                    {automationPerformance?.data?.totalTests && <div className="w-1 h-1 bg-blue-400 rounded-full mr-1 animate-pulse"></div>}
                    {currentSystemMode === 'development' ? 'Test executions completed' : (automationPerformance?.data?.totalTests ? 'Live executions' : 'No execution data')}
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-green-400 flex items-center">
                    ...
                    {currentSystemMode === 'development' ? 'Test mode performance' : ''}
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="text-slate-300 text-sm">Recent Executions</div>
                  <div className="text-2xl font-bold text-blue-400">
                    {currentSystemMode === 'development' ? '6' : (automationPerformance?.recentExecutions?.length || '')}
                  </div>
                  <div className="text-xs text-blue-400 flex items-center">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-green-400 flex items-center">
                    {metrics?.data?.systemUptime && <div className="w-1 h-1 bg-green-400 rounded-full mr-1 animate-pulse"></div>}
                    {currentSystemMode === 'development' ? 'Uptime' : ''}
                  </div>
                </div>
              </div>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-bold">{currentSystemMode === 'development' ? '5' : (metrics?.totalBots || '')}</span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '1.2s' : ''}</span>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-300 text-sm">Bot Errors:</span>
                  <div className="flex items-center space-x-2">
                    <span className="text-red-400 font-bold">{currentSystemMode === 'development' ? '3' : ''}</span>
                    <Button size="sm" variant="ghost" className="text-cyan-400 hover:text-cyan-300 text-xs p-1">
                      {currentSystemMode === 'development' ? '👁 View Details' : ''}
                    </Button>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '23' : (metrics?.data?.dailyActiveUsers || '')}</span>
                  </div>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">System Uptime:</span>
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '99.8%' : (metrics?.data?.systemUptime ? metrics.data.systemUptime + '%' : '')}</span>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right flex items-center space-x-1">
                    ...
                    <span className="text-green-400 font-bold">
                      {currentSystemMode === 'development' ? '$12.5K' : 
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right flex items-center space-x-1">
                    ...
                    <span className="text-emerald-400 font-bold">
                      {currentSystemMode === 'development' ? '247%' : ''}
                    </span>
                  </div>
                </div>
                <div className="flex justify-between">
                  ...
                  <span className="text-blue-400 font-bold">
                    {currentSystemMode === 'development' ? '$85K' : 
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-cyan-400 font-bold">
                    {currentSystemMode === 'development' ? '8.5%' : ''}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Sales Velocity:</span>
                  <span className="text-purple-400 font-bold">
                    {currentSystemMode === 'development' ? '4.7/5' : 
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-white font-bold">{currentSystemMode === 'development' ? '47' : ''}</span>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '87' : ''}</span>
                  </div>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Churn Risk Flags:</span>
                  <span className="text-red-400 font-bold">{currentSystemMode === 'development' ? '0' : ''} {currentSystemMode === 'development' ? 'flagged' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Last Login:</span>
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '2 min ago' : ''}</span>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-slate-300 text-sm">Bot Utilization Rate:</span>
                    <span className="text-cyan-400 font-bold">{currentSystemMode === 'development' ? '93.6%' : ''}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-2">
                    <div className="bg-gradient-to-r from-cyan-500 to-blue-500 h-2 rounded-full transition-all duration-300" style={{width: `${currentSystemMode === 'development' ? '93.6' : '0'}%`}}></div>
                  </div>
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '94.2%' : ''}</span>
                  </div>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Error Trend (7d):</span>
                  <span className="text-red-400 font-bold">{currentSystemMode === 'development' ? '54 errors' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">API Usage:</span>
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '1,068/day' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Bot Processing Load:</span>
                  <span className="text-blue-400 font-bold">{currentSystemMode === 'development' ? '94.2%' : ''}</span>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge className={currentSystemMode === 'development' ? "bg-green-600 text-white" : "bg-slate-600 text-slate-400"}>{currentSystemMode === 'development' ? '12' : ''}</Badge>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-cyan-400 font-bold">{currentSystemMode === 'development' ? '1,847' : ''}</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-300">Success Rate</span>
                  <div className="flex items-center space-x-1">
                    {currentSystemMode === 'development' && <div className="w-1 h-1 bg-green-400 rounded-full animate-pulse"></div>}
                    <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '97.3%' : (automationPerformance?.data?.passRate ? automationPerformance.data.passRate + '%' : '')}</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-300">Avg Completion Time</span>
                  <div className="flex items-center space-x-1">
                    {currentSystemMode === 'development' && <div className="w-1 h-1 bg-purple-400 rounded-full animate-pulse"></div>}
                    <span className="text-purple-400 font-bold">{currentSystemMode === 'development' ? '2.1s' : (metrics?.data?.avgResponseTime ? metrics.data.avgResponseTime + 'ms' : '')}</span>
                  </div>
                </div>
                <div className="bg-blue-900/60 rounded-lg p-3 border border-blue-400 shadow-lg shadow-blue-400/20">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    {currentSystemMode === 'development' && <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse"></div>}
                  </div>
                  <div className="text-blue-400 font-medium">{currentSystemMode === 'development' ? 'Lead follow-up in 15 min' : ''}</div>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-4">
                <div className="bg-slate-800/40 rounded-lg p-3 border-2 border-green-400 shadow-lg shadow-green-400/20">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '$24.50' : ''}</span>
                  </div>
                ...
                <div className="bg-slate-800/40 rounded-lg p-3 border-2 border-blue-400 shadow-lg shadow-blue-400/20">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-blue-400 font-bold">{currentSystemMode === 'development' ? '8.7/10' : ''}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-1 mt-2">
                ...
                <div className="bg-slate-800/40 rounded-lg p-3 border-2 border-purple-400 shadow-lg shadow-purple-400/20">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-purple-400 font-bold">{currentSystemMode === 'development' ? '12.3%' : ''}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-1 mt-2">
                ...
                <div className="bg-slate-800/40 rounded-lg p-3 border-2 border-orange-400 shadow-lg shadow-orange-400/20">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-orange-400 font-bold">{currentSystemMode === 'development' ? '285%' : ''}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-1 mt-2">
                ...
                <div className="bg-slate-800/40 rounded-lg p-3 border-2 border-cyan-400 shadow-lg shadow-cyan-400/20">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-cyan-400 font-bold">{currentSystemMode === 'development' ? '$184' : ''}</div>
                    <Badge className="bg-cyan-600 text-white">{currentSystemMode === 'development' ? '+15%' : ''}</Badge>
                  </div>
              ...
              <div className="space-y-4">
                <div className="bg-slate-800/40 rounded-lg p-3 border-2 border-green-400 shadow-lg shadow-green-400/20">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '87%' : (metrics?.data?.automationEfficiency ? metrics.data.automationEfficiency + '%' : '')}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-1 mt-2">
                ...
                <div className="bg-slate-800/40 rounded-lg p-3 border-2 border-yellow-400 shadow-lg shadow-yellow-400/20">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-yellow-400 font-bold">{currentSystemMode === 'development' ? '$64' : ''}</span>
                      <Badge className="bg-slate-600 text-white text-xs">{currentSystemMode === 'development' ? '--' : ''}</Badge>
                    </div>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-1 mt-2">
                ...
                <div className="bg-slate-800/40 rounded-lg p-3 border-2 border-blue-400 shadow-lg shadow-blue-400/20">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-blue-400 font-bold">{currentSystemMode === 'development' ? '3.2 months' : ''}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-1 mt-2">
                ...
                <div className="bg-slate-800/40 rounded-lg p-3 border-2 border-purple-400 shadow-lg shadow-purple-400/20">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-purple-400 font-bold">{currentSystemMode === 'development' ? '93.6%' : (automationPerformance?.data?.passRate ? automationPerformance.data.passRate + '%' : '')}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-1 mt-2">
                ...
                <div className="bg-slate-800/40 rounded-lg p-3 border-2 border-green-400 shadow-lg shadow-green-400/20">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-green-400 font-bold">{currentSystemMode === 'development' ? '--' : ''}</div>
                    <Badge className="bg-green-600 text-white">{currentSystemMode === 'development' ? '--' : ''}</Badge>
                  </div>
                  {currentSystemMode === 'development' && (
                    <div className="w-full bg-slate-700 rounded-full h-1 mt-2">
                      <div className="bg-green-400 h-1 rounded-full" style={{ width: '0%' }}></div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-purple-400 font-bold">{currentSystemMode === 'development' ? '94.2%' : ''}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-300">Learning Status</span>
                  <Badge className={currentSystemMode === 'development' ? "bg-green-600 text-white" : "bg-slate-600 text-white"}>{currentSystemMode === 'development' ? 'Active Learning' : ''}</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-300" title="Percentage of conversations that needed human assistance">Escalation Rate</span>
                  <span className="text-yellow-400 font-bold">{currentSystemMode === 'development' ? '2.3%' : ''}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-300">Response Accuracy</span>
                  <span className="text-cyan-400 font-bold">{currentSystemMode === 'development' ? '91.7%' : ''}</span>
                </div>
                <div className="bg-purple-900/60 rounded-lg p-3 border border-purple-400 shadow-lg shadow-purple-400/20">
                  ...
                  <div className="text-purple-400 font-medium">{currentSystemMode === 'development' ? 'Customer objection patterns' : ''}</div>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '84%' : ''}</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-cyan-400 font-bold">{currentSystemMode === 'development' ? '147' : ''}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-300">Error Rate</span>
                  <span className="text-yellow-400 font-bold">{currentSystemMode === 'development' ? '0.3%' : ''}</span>
                </div>
                <div className="bg-blue-900/60 rounded-lg p-3 border border-blue-400 shadow-lg shadow-blue-400/20">
                  <div className="text-slate-300 text-sm mb-1">System Status</div>
                  <div className="text-green-400 font-medium">{currentSystemMode === 'development' ? 'All Systems Operational' : ''}</div>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg border-2 border-blue-400 shadow-lg shadow-blue-400/20">
                  ...
                  <Badge variant="outline" className="text-green-400 border-green-400">{currentSystemMode === 'development' ? 'Active' : ''}</Badge>
                </div>
                <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg border-2 border-blue-400 shadow-lg shadow-blue-400/20">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '7.8/10' : ''}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-300">Avg Call Duration</span>
                  <span className="text-blue-400 font-bold">{currentSystemMode === 'development' ? '8:42' : ''}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-slate-300">Resolution Rate</span>
                  <span className="text-purple-400 font-bold">{currentSystemMode === 'development' ? '89.2%' : ''}</span>
                </div>
                <div className="bg-blue-900/60 rounded-lg p-3 border border-blue-400 shadow-lg shadow-blue-400/20">
                  <div className="text-slate-300 text-sm mb-1">Top Intent</div>
                  <div className="text-cyan-400 font-medium">{currentSystemMode === 'development' ? 'Product pricing inquiry' : 'No data available'}</div>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="text-white font-bold">
                    {currentSystemMode === 'development' ? '6 total meetings' : (metrics?.activeCampaigns || 0) + ' total meetings'}
                  </div>
                  <div className="text-cyan-400 text-xs">
                    {currentSystemMode === 'development' ? '2 remaining today' : (metrics?.remainingTasks || 0) + ' remaining today'}
                  </div>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '68%' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Neutral:</span>
                  <span className="text-blue-400 font-bold">{currentSystemMode === 'development' ? '24%' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Negative:</span>
                  <span className="text-red-400 font-bold">{currentSystemMode === 'development' ? '8%' : ''}</span>
                </div>
                <div className="bg-blue-900/60 rounded-lg p-3 border border-blue-400 shadow-lg shadow-blue-400/20">
                  <div className="text-slate-300 text-sm mb-1">Overall Score</div>
                  <div className="text-green-400 font-bold">{currentSystemMode === 'development' ? '7.8/10' : ''}</div>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-bold">{currentSystemMode === 'development' ? '14' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Success Rate:</span>
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '92.3%' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Processing:</span>
                  <span className="text-blue-400 font-bold">{currentSystemMode === 'development' ? '1 active' : ''}</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '3' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Deployed Today:</span>
                  <span className="text-blue-400 font-bold">{currentSystemMode === 'development' ? '1' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Success Rate:</span>
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '96.8%' : ''}</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
              ...
              <div className="bg-slate-800/40 rounded-lg p-4 border border-slate-600">
                <div className="text-center mb-3">
                  <div className="text-2xl font-black text-green-400 mb-1">{currentSystemMode === 'development' ? '$8.50' : ''}</div>
                  <div className="text-slate-300 text-sm">Cost Per Lead</div>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-xs">
                    <span className="text-slate-400">Last Month</span>
                    <span className="text-cyan-400">{currentSystemMode === 'development' ? '$12.30' : ''}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-2">
                    <div className={`bg-green-400 h-2 rounded-full ${currentSystemMode === 'development' ? 'w-3/4' : 'w-0'}`}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/40 rounded-lg p-4 border border-slate-600">
                <div className="text-center mb-3">
                  <div className="text-2xl font-black text-blue-400 mb-1">{currentSystemMode === 'development' ? '94.2%' : ''}</div>
                  <div className="text-slate-300 text-sm">Accuracy Rate</div>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-xs">
                    <span className="text-slate-400">Target</span>
                    <span className="text-green-400">{currentSystemMode === 'development' ? '90%' : ''}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-2">
                    <div className={`bg-blue-400 h-2 rounded-full ${currentSystemMode === 'development' ? 'w-[94%]' : 'w-0'}`}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/40 rounded-lg p-4 border border-slate-600">
                <div className="text-center mb-3">
                  <div className="text-2xl font-black text-purple-400 mb-1">{currentSystemMode === 'development' ? '78%' : ''}</div>
                  <div className="text-slate-300 text-sm">Learning Rate</div>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-xs">
                    <span className="text-slate-400">Weekly</span>
                    <span className="text-yellow-400">{currentSystemMode === 'development' ? '+12%' : ''}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-2">
                    <div className={`bg-purple-400 h-2 rounded-full ${currentSystemMode === 'development' ? 'w-[78%]' : 'w-0'}`}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/40 rounded-lg p-4 border border-slate-600">
                <div className="text-center mb-3">
                  <div className="text-2xl font-black text-cyan-400 mb-1">{currentSystemMode === 'development' ? '142' : ''}</div>
                  <div className="text-slate-300 text-sm">Interactions</div>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-xs">
                    <span className="text-slate-400">Today</span>
                    <span className="text-emerald-400">{currentSystemMode === 'development' ? '38' : ''}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-2">
                    <div className={`bg-cyan-400 h-2 rounded-full ${currentSystemMode === 'development' ? 'w-[85%]' : 'w-0'}`}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-800/40 rounded-lg p-4 border border-slate-600">
                <div className="text-center mb-3">
                  <div className="text-2xl font-black text-emerald-400 mb-1">{currentSystemMode === 'development' ? '8.5%' : ''}</div>
                  <div className="text-slate-300 text-sm">Close Rate</div>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-xs">
                    <span className="text-slate-400">Industry Avg</span>
                    <span className="text-orange-400">{currentSystemMode === 'development' ? '3.2%' : ''}</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-2">
                    <div className={`bg-emerald-400 h-2 rounded-full ${currentSystemMode === 'development' ? 'w-[85%]' : 'w-0'}`}></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              <div className="bg-gradient-to-br from-green-600/20 to-green-800/20 border border-blue-400 shadow-lg shadow-blue-400/20 rounded-lg p-4">
                <div className="text-center">
                  <div className="text-3xl font-black text-green-400 mb-2">{currentSystemMode === 'development' ? '$3,240' : ''}</div>
                  <div className="text-slate-300 text-sm">Monthly Savings</div>
                  <div className="w-full bg-slate-700 rounded-full h-2 mt-2">
                    <div className={`bg-green-400 h-2 rounded-full ${currentSystemMode === 'development' ? 'w-4/5' : 'w-0'}`}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 border border-blue-400 shadow-lg shadow-blue-400/20 rounded-lg p-4">
                <div className="text-center">
                  <div className="text-3xl font-black text-blue-400 mb-2">{currentSystemMode === 'development' ? '67%' : ''}</div>
                  <div className="text-blue-300 text-sm">Cost Reduction</div>
                  <div className="w-full bg-slate-700 rounded-full h-2 mt-2">
                    <div className={`bg-blue-400 h-2 rounded-full ${currentSystemMode === 'development' ? 'w-2/3' : 'w-0'}`}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-600/20 to-purple-800/20 border border-blue-400 shadow-lg shadow-blue-400/20 rounded-lg p-4">
                <div className="text-center">
                  <div className="text-3xl font-black text-purple-400 mb-2">{currentSystemMode === 'development' ? '340%' : ''}</div>
                  <div className="text-slate-300 text-sm">ROI</div>
                  <div className="w-full bg-slate-700 rounded-full h-2 mt-2">
                    <div className={`bg-purple-400 h-2 rounded-full ${currentSystemMode === 'development' ? 'w-full' : 'w-0'}`}></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-yellow-600/20 to-yellow-800/20 border border-blue-400 shadow-lg shadow-blue-400/20 rounded-lg p-4">
                <div className="text-center">
                  <div className="text-3xl font-black text-yellow-400 mb-2">{currentSystemMode === 'development' ? '42' : ''}</div>
                  <div className="text-slate-300 text-sm">Payback Days</div>
                  <div className="w-full bg-slate-700 rounded-full h-2 mt-2">
                    <div className={`bg-yellow-400 h-2 rounded-full ${currentSystemMode === 'development' ? 'w-1/3' : 'w-0'}`}></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-bold">{currentSystemMode === 'development' ? '23' : (metrics?.activeCalls || '')}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Avg Duration:</span>
                  <span className="text-cyan-400 font-bold">{currentSystemMode === 'development' ? '7:42' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Conversion Rate:</span>
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '15.2%' : ''}</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '17' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Conversions:</span>
                  <span className="text-blue-400 font-bold">{currentSystemMode === 'development' ? '4' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Escalations:</span>
                  <span className="text-yellow-400 font-bold">{currentSystemMode === 'development' ? '2' : ''}</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-cyan-400 font-bold">{currentSystemMode === 'development' ? '127' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Hours Saved:</span>
                  <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '34.2' : ''}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-300 text-sm">Efficiency:</span>
                  <span className="text-purple-400 font-bold">{currentSystemMode === 'development' ? '89.7%' : ''}</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-900/80 via-blue-900/80 to-indigo-900/80 backdrop-blur-sm border border-purple-400/50 shadow-2xl shadow-purple-500/30">
            <CardHeader className="border-b border-purple-400/30">
              <CardTitle className="text-white flex items-center text-2xl font-bold">
                ...
                🧠 RAG Knowledge Base
                <Badge className="ml-3 bg-green-600 text-white">{currentSystemMode === 'development' ? 'ACTIVE' : ''}</Badge>
              </CardTitle>
            </CardHeader>
              ...
              <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className={`text-xs font-bold px-2 py-1 rounded ${
                            ...
                            {currentSystemMode === 'development' ? (serviceStates.analytics.status === 'ACTIVE' ? '🟢 ACTIVE' :
                ...
                <div className="grid grid-cols-4 gap-3">
                  <div className="bg-slate-700/40 rounded-lg p-3 text-center border border-blue-400">
                    ...
                    <div className="text-white font-bold text-lg">{currentSystemMode === 'development' ? callStats.activeCalls : ''}</div>
                  </div>
                  <div className="bg-slate-700/40 rounded-lg p-3 text-center border border-blue-400">
                    <div className="text-slate-300 text-xs mb-1">Avg Duration</div>
                    <div className="text-white font-bold text-lg">{currentSystemMode === 'development' ? callStats.avgDuration : ''}</div>
                  </div>
                  <div className="bg-slate-700/40 rounded-lg p-3 text-center border border-blue-400">
                    <div className="text-slate-300 text-xs mb-1">Success Rate</div>
                    <div className="text-white font-bold text-lg">{currentSystemMode === 'development' ? callStats.successRate : ''}</div>
                  </div>
                  <div className="bg-slate-700/40 rounded-lg p-3 text-center border border-blue-400">
                    <div className="text-slate-300 text-xs mb-1">Total Today</div>
                    <div className="text-white font-bold text-lg">{currentSystemMode === 'development' ? callStats.totalToday : ''}</div>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-700/40 rounded-lg p-4 border border-purple-400">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-green-400 font-bold text-sm">{currentSystemMode === 'development' ? 'Online' : ''}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-300 text-sm">Open Tickets</span>
                    <span className="text-white font-bold">{currentSystemMode === 'development' ? '4' : ''}</span>
                  </div>
                </div>
                  ...
                  <div className="space-y-2 max-h-32 overflow-y-auto">
                    {recentActivity.length > 0 ? recentActivity.map((activity) => (
                      ...
                      <div className="text-slate-400 text-xs text-center py-2">
                        {currentSystemMode === 'development' ? 'No recent support activity' : ''}
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-white font-medium">
                      {currentSystemMode === 'development' ? (selectedDay === 0 ? '15' : selectedDay === 1 ? '12' : selectedDay === 2 ? '10' : selectedDay === 3 ? '11' : selectedDay === 4 ? '9' : selectedDay === 5 ? '8' : '5') : ''}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-300">Client Calls:</span>
                    <span className="text-green-400 font-medium">
                      {currentSystemMode === 'development' ? (selectedDay === 0 ? '6' : selectedDay === 1 ? '4' : selectedDay === 2 ? '3' : selectedDay === 3 ? '4' : selectedDay === 4 ? '3' : selectedDay === 5 ? '3' : '2') : ''}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-300">Internal Meetings:</span>
                    <span className="text-blue-400 font-medium">
                      {currentSystemMode === 'development' ? (selectedDay === 0 ? '9' : selectedDay === 1 ? '8' : selectedDay === 2 ? '7' : selectedDay === 3 ? '7' : selectedDay === 4 ? '6' : selectedDay === 5 ? '5' : '3') : ''}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                <div className="bg-slate-800/60 rounded-lg p-4 border border-blue-400">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      <span className="text-slate-300 text-sm">Success Rate:</span>
                      <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '94.7%' : ''}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-300 text-sm">Avg Duration:</span>
                      <span className="text-blue-400 font-bold">{currentSystemMode === 'development' ? '3m 42s' : ''}</span>
                    </div>
                  </div>
                </div>
                <div className="bg-slate-800/60 rounded-lg p-4 border border-green-400">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white font-bold">{currentSystemMode === 'development' ? '23' : ''}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-300 text-sm">Conversions:</span>
                      <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '12' : ''}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-300 text-sm">Est. Revenue:</span>
                      <span className="text-green-400 font-bold">{currentSystemMode === 'development' ? '$34,200' : ''}</span>
                    </div>
                  </div>
                </div>
                <div className="bg-slate-800/60 rounded-lg p-4 border border-purple-400">
